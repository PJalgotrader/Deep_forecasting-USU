...
- [ ] Step 5 - question bank: reword m2_p1 Q17 (`DATA5630_question_bank/m2_bank/m2_p1_Qbank.md`) to point at `python_migration/uv`
- [ ] Step 6 - replace / retire `Module 2- Setting up Deep Forecasting Environment/DF_environment.yml` (Python 3.7, no pycaret) and update the Module 2 slides
